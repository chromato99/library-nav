...
for(let i = 0; i < 8; i++) {
    node[3][5+i].book_num_start = 100 + (i * 12);
    node[3][5+i].book_num_end = 115 + (i * 12);
}
...
for(let i = 0; i < 8; i++) {
    node[3][21+i].book_num_start = 300 + (i * 4);
    node[3][21+i].book_num_end = 303 + (i * 4);
}

for(let i = 0; i < 8; i++) {
    node[5][28-i].book_num_start = 332 + (i * 4);
    node[5][28-i].book_num_end = 335 + (i * 4);
}
...
for(let i = 0; i < 8; i++) {
    node[7][17+i].book_num_start = 600 + (i * 8);
    node[7][17+i].book_num_end = 611 + (i * 8);
}
