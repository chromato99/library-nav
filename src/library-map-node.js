...
for(let x = 0; x < 20; x++) {
    ...
    for(let y = 0; y < 30; y++) {
        node[x][y] = {
            vertices: new Array(), // store neighbor vertices position and distance
            check: false, // check this node is available
            book_num_start: 0, // declare book number range
            book_num_end: 0,
            pos: { // position of this node
                x: x,
                y: y
            }
        };
